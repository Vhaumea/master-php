            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
						...
						<li class="nav-item">
							<a href="<?php echo e(route('user.index')); ?>" class="nav-link">Gente</a>
						</li>
						<li class="nav-item">
							<a href="<?php echo e(route('likes')); ?>" class="nav-link">Favoritas</a>
						</li>
						<li class="nav-item">
							<a href="<?php echo e(route('image.create')); ?>" class="nav-link">Subir imagen</a>
						</li>
